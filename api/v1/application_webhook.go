...
//+kubebuilder:webhook:path=/mutate-apps-isadba-com-v1-application,mutating=true,failurePolicy=fail,sideEffects=None,groups=apps.isadba.com,resources=applications,verbs=create;update,versions=v1,name=mapplication.kb.io,admissionReviewVersions=v1
...
//+kubebuilder:webhook:path=/validate-apps-isadba-com-v1-application,mutating=false,failurePolicy=fail,sideEffects=None,groups=apps.isadba.com,resources=applications,verbs=create;update,versions=v1,name=vapplication.kb.io,admissionReviewVersions=v1
